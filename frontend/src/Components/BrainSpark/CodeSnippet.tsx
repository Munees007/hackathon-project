    ...
    return(
      <div className="flex justify-center gap-5 w-full max-sm:flex-col max-sm:items-center max-sm:gap-3 max-sm:m-2">
        ...
        <div className="w-fit  p-6 rounded-2xl shadow-md border border-gray-200">
          <p className="font-[Orbitron] font-bold uppercase tracking-widest text-xl text-white mb-4">Syntax Surge</p>
      {/* 💻 Code Snippet */}
      <motion.pre
      
        className="parent select-none bg-purple-500/10 backdrop-blur-[1px] text-gray-900 p-4 rounded-lg shadow-inner border border-gray-300 font-mono text-lg whitespace-pre-wrap"
